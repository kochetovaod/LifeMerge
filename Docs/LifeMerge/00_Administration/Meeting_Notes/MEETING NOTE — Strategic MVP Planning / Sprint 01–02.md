...
* Уточнено разделение спринтов:
  ...
  * Sprint 02 — A2 + связки + AI Planner v1 (Goals, Task→Calendar, Calendar drag&drop, AI Planner v1, Goal Progress, Calendar Conflicts basic, Digest push).
...
* Подтверждена готовность Mobile к старту фич (слои, DI, навигация shell, storage-контракты).
...
| D2  | Разделение спринтов: Sprint 01 = фундамент + A1, Sprint 02 = A2 + AI Planner                                                                         | Снижение риска расползания скопа, фокус на быстрой активации и устойчивом фундаменте                          | Олег / Антон                   |
...
| D6  | AI Planner v1 на MVP работает как rule-based+LLM с минимальным контрактом (Tasks, Calendar, Preferences, Goals)                                      | Быстрый запуск Pro-ценности, минимизация рисков ML и сложности персонализации на старте                       | Олег / Игорь                   |
...
| #  | Action Item                                                                                                                          | Owner                              | Deadline                           | Статус |
| -- | ------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------- | ---------------------------------- | ------ |
| M1 | Завершить и зафиксировать архитектуры (слои, DI, навигация shell, storage-контракты)                                        | Даниил                             | до конца 1-й недели Sprint 01      | Open   |
